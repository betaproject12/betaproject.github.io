...
@include('includes.tailwindscript')
 ...
 <!-- Title -->
    <div class="mt-5 max-w-2xl text-center mx-auto">
      <h1 class="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
        Welcome to My
        <span class="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent">Website</span>
      </h1>
    </div>
<!-- End Title -->
...
<!-- Curhat -->
    <div class="mt-5 max-w-3xl text-center mx-auto">
      <p class="text-lg text-gray-600 dark:text-neutral-400">Ini Adalah Website Pertama Saya Yang Di Buat Menggunakan laravel, livewire, filament, tailwind dan prelineUi.</p>
    </div>
<!-- End Curhat -->

<!-- ========== FOOTER ========== -->
<footer class="mt-20 w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <!-- Grid -->
  <div class="text-center">
    <div>
      <a class="hover-effect transition duration-500 ease-in-out hover:bg-slate-700 shadow-lg rounded-lg flex-none text-xl font-semibold text-red-700 dark:text-white" href="#" aria-label="Brand">ThokenAzter</a>
    </div>
    <!-- End Col -->
    ...
    <div class="mt-3">
      ...
      <a href="https://laravel.com/" class="hover:text-blue-400">Laravel</a>
      <a href="https://filamentadmin.com/ "class="hover:text-blue-400">Filament</a>
      <a href="https://laravel-livewire.com/ "class="hover:text-blue-400">Live Wire</a>
      <a href="https://tailwindcss.com/ "class="hover:text-blue-400">Tailwindcss</a>
      <a href="https://prelalui.com/ "class="hover:text-blue-400">Preline UI</a>
    </div>
